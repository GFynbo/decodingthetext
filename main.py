...
# Emotion Message
printed_em = False # check make sure not print max if printed an emotion already
second_pr = False # check if printed more than one message, so prints accordingly

if emotion1['joy'] >= 0.3:
    print("They seem pretty joyful!",Happy)
    printed_em = True
    second_pr = True
if emotion1['anger'] >= 0.3:
    if second_pr == True:
        print("And, they also seem pretty angry.",Angry)
        printed_em = True
    else:
        print("They seem pretty angry.",Angry)
        printed_em = True
        second_pr = True
if emotion1['fear'] >= 0.3:
    if second_pr == True:
        print("And, they also seem pretty fearful.",Fear)
        printed_em = True
    else:
        print("They seem pretty fearful.",Fear)
        printed_em = True
        second_pr = True
if emotion1['surprise'] >= 0.3:
    if second_pr == True:
        print("And, they also seem pretty surprised!",Surprise)
        printed_em = True
    else:
        print("They seem pretty surprised!",Surprise)
        printed_em = True
        second_pr = True
if emotion1['sadness'] >= 0.3:
    if second_pr == True:
        print("And, they also seem pretty sad.",Sad)
        printed_em = True
    else:
        print("They seem pretty sad.",Sad)
        printed_em = True
...
if persona1['logistician'] >= 0.5:
    print("It looks like you are dealing with a logistician\n")
elif persona1['consul'] >= 0.5:
    print("It looks like you are dealing with a consul\n")
elif persona1['protagonist'] >= 0.5:
    print("It looks like you are dealing with a protagonist\n")
elif persona1['advocate'] >= 0.5:
    print("It looks like you are dealing with a advocate\n")
elif persona1['logician'] >= 0.5:
    print("It looks like you are dealing with a logician\n")
elif persona1['adventurer'] >= 0.5:
    print("It looks like you are dealing with a adventurer\n")
elif persona1['mediator'] >= 0.5:
    print("It looks like you are dealing with a mediator\n")
elif persona1['entrepreneur'] >= 0.5:
    print("It looks like you are dealing with a entrepreneur\n")
elif persona1['architect'] >= 0.5:
    print("It looks like you are dealing with a architect\n")
elif persona1['virtuoso'] >= 0.5:
    print("It looks like you are dealing with a virtuoso\n")
elif persona1['campaigner'] >= 0.5:
    print("It looks like you are dealing with a campaigner\n")
elif persona1['defender'] >= 0.5:
    print("It looks like you are dealing with a defender\n")
elif persona1['debater'] >= 0.5:
    print("It looks like you are dealing with a debater\n")
elif persona1['commander'] >= 0.5:
    print("It looks like you are dealing with a commander\n")
elif persona1['executive'] >= 0.5:
    print("It looks like you are dealing with a executive\n")
elif persona1['entertainer'] >= 0.5:
    print("It looks like you are dealing with a entertainer\n")
...
print("It looks like you are dealing with a(n)",temp_str, ".\n")
